...
$string['modulename'] = 'Tablero b13';
$string['pluginname'] = 'Tablero b13';
$string['b13_dashboard:view'] = 'Ver Tablero b13';
$string['b13_dashboard:manage'] = 'Mánager Tablero b13';
$string['dashboard'] = 'Tablero';
$string['settings'] = 'Configuraciones';
$string['close'] = 'Cerrar';
$string['crontask_tmp'] = 'Cron limpiar carpeta tmp';

$string['b13_dashboard_open'] = 'Abrir b13';
$string['b13_dashboard_open_desc'] = '¿Qué forma desea abrir el Tablero b13';
$string['b13_dashboard_open_internal'] = 'Abrir interno';
$string['b13_dashboard_open_popup'] = 'En popup';
$string['b13_dashboard_open_blank'] = 'En nueva ventana';
$string['b13_dashboard_open_top'] = 'En la misma ventana';

$string['integracaoroot'] = 'Integraciones';

$string['messageprovider:b13_dashboard_messages'] = 'Enviar Notificaciones';
$string['b13_dashboard:emailconfirmsubmission'] = 'Enviar Notificaciones';
...
$string['backup_delete_title'] = '¿Realmente desea eliminar el respaldo <strong>{$a->file}</strong> creado en <strong>{$a->date}</strong>';
...
$string['backup_hours'] = '¡No correr resplado en horas pico!';
...
$string['benchmark_info'] = '<p>Esta prueba puede tardar hasta 1 minuto para ejecutarse.</p><p>Intente hacr más de una prueba para tener un promedio.</p><p>Y, no la corra en horas pico.</p>';
...
$string['notification_local_b13_dashboard'] = 'Tablero b13';
$string['notification_local_b13_hotmoodle'] = 'HotMoodle b13';
$string['notification_local_b13_moocommerce'] = 'MooCommerce b13';
$string['notification_local_b13_dashboard_payment'] = 'Pago b13';
...
$string['processormoreinfo'] = 'Una función es llamda en un bucle para probar la velocidad del procesador';
$string['processorname'] = 'Funciónllamada muchas veces';
...
$string['reports_report_badge-2'] = 'Todos los emblemas Contenidos por Usuarios';
...
$string['userenrolment_status'] = 'El Registro está';
$string['userenrolment_status_active'] = 'Activo';
$string['userenrolment_status_inactive'] = 'Inactivo';
$string['userenrolment_timeend'] = 'La suscripción termina en';
$string['userenrolment_timeendstatus'] = 'Habilitar período de suscripción';
$string['userenrolment_timestart'] = 'La suscripción inicia en';
...
$string['webpages_menu_error'] = '¡Dene llenarse todos los datos!';
...
$string['webpages_menu_link'] = 'Link del Menú';
...
$string['privacy:metadata'] = 'El complemento de b13 Dashboard no almacena ningún dato personal.';