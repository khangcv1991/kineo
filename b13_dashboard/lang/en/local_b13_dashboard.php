...
$string['b13_dashboard:view'] = 'View b13 Dashboard';
$string['b13_dashboard:manage'] = 'Manage b13 Dashboard';
$string['dashboard'] = 'Dashboard';
$string['settings'] = 'Settings';
$string['close'] = 'Close';
$string['crontask_tmp'] = 'Cron clear tmp folder';

$string['b13_dashboard_open'] = 'Open b13';
$string['b13_dashboard_open_desc'] = 'Which way do you want to open b13 Dashboard';
$string['b13_dashboard_open_internal'] = 'Open internal';
$string['b13_dashboard_open_popup'] = 'In popup';
$string['b13_dashboard_open_blank'] = 'In new window';
$string['b13_dashboard_open_top'] = 'In the same window';

$string['integracaoroot'] = 'Integration';

$string['messageprovider:b13_dashboard_messages'] = 'Send Notifications';
$string['b13_dashboard:emailconfirmsubmission'] = 'Send Notifications';
...
$string['notification_local_b13_dashboard_payment'] = 'b13 Payment';
...
$string['userimport_firstname_desc'] = 'If you have the full name in CSV, just fill in this field b13 will be responsible for generating both fields. ' .
...
$string['privacy:metadata'] = 'The b13 Dashboard plugin does not store any personal data.';
