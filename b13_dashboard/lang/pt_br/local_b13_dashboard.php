...
$string['modulename'] = 'b13 Dashboard';
$string['pluginname'] = 'b13 Dashboard';
$string['b13_dashboard:view'] = 'Ver b13 Dashboard';
$string['b13_dashboard:manage'] = 'Gerenciar b13 Dashboard';
$string['dashboard'] = 'Dashboard';
$string['settings'] = 'Configurar';
$string['close'] = 'Fechar';
$string['crontask_tmp'] = 'Cron que limpa a pasta TMP';

$string['b13_dashboard_open'] = 'Abrir o b13';
$string['b13_dashboard_open_desc'] = 'Qual forma deseja abrir o b13 Dashboard';
$string['b13_dashboard_open_internal'] = 'Abrir interno';
$string['b13_dashboard_open_popup'] = 'Em popup';
$string['b13_dashboard_open_blank'] = 'Em nova janela';
$string['b13_dashboard_open_top'] = 'Na mesma janela';

$string['integracaoroot'] = 'Integrações';

$string['messageprovider:b13_dashboard_messages'] = 'Envia Notificações';
$string['b13_dashboard:emailconfirmsubmission'] = 'Envia Notificações';
...
$string['courses_acess'] = 'Acessar';
$string['courses_titleenrol'] = 'Alunos matrículados';
$string['courses_student_name'] = 'Nome';
...
$string['notification_local_b13_dashboard'] = 'b13 Dashboard';
$string['notification_local_b13_hotmoodle'] = 'b13 HotMoodle';
$string['notification_local_b13_moocommerce'] = 'b13 MooCommerce';
$string['notification_local_b13_pay'] = 'b13 Pagamento';
...
$string['userimport_firstname_desc'] = 'Se no CSV você possuir o nome completo, preencha apenas este campo que o b13 se encarrega de gerar os dois campos. ' .
...
$string['privacy:metadata'] = 'O plugin do b13 Dashboard não armazena nenhum dado pessoal.';