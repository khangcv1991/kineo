...
namespace local_b13_dashboard\install;
 ...
 *
 * @package local_b13_dashboard\install
 */
class report_install {
    ...
    public static function create_categores() {
        ...
        $reportcat = b13_dashboard_reportcat::create_by_default();
    ...
    public static function create_reports() {
        ...
        $report = b13_dashboard_reports::create_by_default();
        $report->reportcatid = $DB->get_field('b13_dashboard_reportcat', 'id', array('type' => 'badge'));
        ...
        $report->foreach = 'local_b13_dashboard\report\report_foreach::badge_status_text';
        ...
        $report->foreach = 'local_b13_dashboard\report\report_foreach::badge_criteria_type';
        $report->columns = json_encode(array('columns' => $report->columns));
        self::report_insert($report);


        $report = b13_dashboard_reports::create_by_default();
        $report->reportcatid = $DB->get_field('b13_dashboard_reportcat', 'id', array('type' => 'courses'));
        ...
        $report->foreach = 'local_b13_dashboard\report\report_foreach::userfullname';
        ...
        $report->foreach = 'local_b13_dashboard\report\report_foreach::courses_group_mode';
        $report->columns = json_encode(array('columns' => $report->columns));
        self::report_insert($report);
        ...
        $report->prerequisit = 'listCourses';
        $report->reportsql = 'local_b13_dashboard\\report\\custom\\course_access';
        $report->columns = '';
        self::report_insert($report);
        ...
        $report->prerequisit = 'listCourses';
        $report->reportsql = 'local_b13_dashboard\\report\\custom\\course_access_grade';
        $report->columns = '';
        self::report_insert($report);
        ...
        $report->prerequisit = 'listCourses';
        $report->reportsql = 'local_b13_dashboard\\report\\custom\\course_last_access';
        $report->columns = '';
        self::report_insert($report);


        $report = b13_dashboard_reports::create_by_default();
        $report->reportcatid = $DB->get_field('b13_dashboard_reportcat', 'id', array('type' => 'enrol_cohort'));
        ...
        $report = b13_dashboard_reports::create_by_default();
        $report->reportcatid = $DB->get_field('b13_dashboard_reportcat', 'id', array('type' => 'enrol_guest'));
        ...
        $report = b13_dashboard_reports::create_by_default();
        $report->reportcatid = $DB->get_field('b13_dashboard_reportcat', 'id', array('type' => 'server'));
        ...
        $report = b13_dashboard_reports::create_by_default();
        $report->reportcatid = $DB->get_field('b13_dashboard_reportcat', 'id', array('type' => 'user'));
    ...
    private static function report_cat_insert($reportcat) {
        ...
        $b13reportcat = $DB->get_record('b13_dashboard_reportcat', array('type' => $reportcat->type));
        if (!$b13reportcat) {
            $DB->insert_record('b13_dashboard_reportcat', $reportcat);
        }
    }
    ...
    private static function report_insert($report) {
        ...
        $b13reports = $DB->get_record('b13_dashboard_reports', array('reportkey' => $report->reportkey));
        if (!$b13reports) {
            $DB->insert_record('b13_dashboard_reports', $report);
        }
    }
}