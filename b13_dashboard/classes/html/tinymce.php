...
namespace local_b13_dashboard\html;
...
class tinymce {
    ...
    public static function register() {
        ...
        return '<script src="' . $CFG->wwwroot . '/local/b13_dashboard/vendor/tinymce/tinymce/tinymce.min.js"
    ...
    public static function create_input_editor($seletor = '.tinymce_editor_box', $id = 0) {
        global $CFG;
        $filemanager = $CFG->wwwroot . '/local/b13_dashboard/vendor/responsivefilemanager/';

        $external_plugins = '';
        if (file_exists("{$filemanager}dialog.php")) {
            $external_plugins = "
                external_filemanager_path : '{$filemanager}',
                filemanager_title         : '" . get_string_b13('filemanager_title') . "',
                external_plugins          : {
        ...
        $returnhtml
            ...
            tinymce.init ( {
                ...
                style_formats : [
                    ...
                    {
                        title : '" . get_string_b13('blocks') . "', items : [
                            { title : '" . get_string_b13('blocks_paragraph') . "',  block : 'p' },
                            { title : 'Blockquote', block : 'blockquote' },
                            { title : 'Div',        block : 'div' }
                        ]
                    },
                    {
                        title : '" . get_string_b13('image_alignment') . "', items : [
                            {
                                title    : '" . get_string_b13('image_alignment_left') . "',
                                selector : 'img',
                                styles   : { 'float' : 'left', 'margin' : '0 10px 0 10px' }
                            },
                            {
                                title    : '" . get_string_b13('image_alignment_right') . "',
                                selector : 'img',
                    ...
                    {
                        title : '" . get_string_b13('colors') . "', items : [
                            { title : '" . get_string_b13('color_red') . "', inline : 'span', styles :
                                { color : '#D81B60' } },
                            { title : '" . get_string_b13('color_red') . "', inline : 'span', styles :
                                { color : '#E53935' } },
                            { title : '" . get_string_b13('color_red') . "', inline : 'span', styles :
                            ...
                            { title : '" . get_string_b13('color_purple') . "', inline : 'span', styles :
                                { color : '#9C27B0' } },
                            { title : '" . get_string_b13('color_brown') . "', inline : 'span', styles :
                                { color : '#5d4037' } },

                            { title : '" . get_string_b13('color_blue') . "', inline : 'span', styles :
                                { color : '#3F51B5' } },
                            { title : '" . get_string_b13('color_blue') . "', inline : 'span', styles :
                                { color : '#1565C0' } },
                            { title : '" . get_string_b13('color_blue') . "', inline : 'span', styles :
                            ...
                            { title : '" . get_string_b13('color_green') . "', inline : 'span', styles :
                                { color : '#009688' } },
                            { title : '" . get_string_b13('color_green') . "', inline : 'span', styles :
                                { color : '#43A047' } },
                            { title : '" . get_string_b13('color_green') . "', inline : 'span', styles :
                            ...
                            { title : '" . get_string_b13('color_yellow') . "', inline : 'span', styles :
                                { color : '#AFB42B' } },
                            { title : '" . get_string_b13('color_yellow') . "', inline : 'span', styles :
                                { color : '#FDD835' } },

                            { title : '" . get_string_b13('color_orange') . "', inline : 'span', styles :
                                { color : '#FDD835' } },
                            { title : '" . get_string_b13('color_orange') . "', inline : 'span', styles :
                                { color : '#FFA000' } },
                            { title : '" . get_string_b13('color_orange') . "', inline : 'span', styles :
                            ...
                            { title : '" . get_string_b13('color_grey') . "', inline : 'span', styles :
                                { color : '#757575' } },
                            { title : '" . get_string_b13('color_grey') . "', inline : 'span', styles :
                                { color : '#607D8B' } }
                        ]
                    ...
                    {
                        title : '" . get_string_b13('background') . "', items : [
                            { title : '" . get_string_b13('color_red') . "', inline : 'span', styles :
