...
class button {
    ...
    public static function help($infourl, $text = null, $hastag = 'wiki-wrapper') {
        ...
        if ($text == null) {
            $text = get_string_b13('help_title');
        }

        return "<a href=\"https://github.com/EduardoKrausME/moodle-local-b13_dashboard/wiki/{$infourl}#{$hastag}\"
                   target=\"_blank\" class=\"help\">
                  <img src=\"{$CFG->wwwroot}/local/b13_dashboard/assets/dashboard/img/help.svg\" height=\"23\" >
                  $text
              </a>";
    }
        ...
        if ($ispopup) {
            return "<a data-toggle=\"modal\" data-target=\"#modal-edit\"
                       ...
                       data-href=\"load-ajax.php{$link}\">
                        <img src=\"{$CFG->wwwroot}/local/b13_dashboard/assets/dashboard/img/actions/{$icon}.svg\" width=\"19\">
                    </a>";
        } else {
            return "<a href=\"{$link}\">
                        <img src=\"{$CFG->wwwroot}/local/b13_dashboard/assets/dashboard/img/actions/{$icon}.svg\" width=\"19\">
    ...
    public static function icon_popup_table($icon, $link) {
        global $CFG;
        return "<img src=\"{$CFG->wwwroot}/local/b13_dashboard/assets/dashboard/img/actions/{$icon}.svg\" 
