...
namespace local_b13_dashboard\util;
 ...
 *
 * @package local_b13_dashboard\util
 */
class dashboard_util {
    /**
     * @var string
            ...
            $link
                .= "<div class=\"setting\">
                        <a data-toggle=\"modal\" data-target=\"#modal-edit\"
                           ...
                           href=\"#\">
                            <img src=\"{$CFG->wwwroot}/local/b13_dashboard/assets/dashboard/img/top-settings.svg\"
                                 alt=\"Settings\" >
                        </a>
                    </div>";
        }
        ...
        if (AJAX_SCRIPT) {
            ...
            $return
                .= "<ul class=\"breadcrumb\">
                        ...
                        <li>
                            <a href=\"?classname=dashboard&method=start\">" . get_string_b13('dashboard') . "</a>
                        </li>";
    ...
    public static function add_menu(menu_util $menu) {
        ...
        if ($submenuhtml != '') {
            $submenuhtml = "<ul class='submenu submenu-b13'>{$submenuhtml}</ul>";
        }
