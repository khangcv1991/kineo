...
namespace local_b13_dashboard\output\events;
 ...
 * Class send_events
 *
 * @package local_b13_dashboard\output\events
 */
class send_events {
    /** @var b13_dashboard_events */
    private $b13_dashboard_events;
    ...
    /**
     * @return b13_dashboard_events
     */
    public function get_b13_dashboard_events() {
        return $this->b13_dashboard_events;
    }

    /**
     * @param b13_dashboard_events $b13events
     */
    public function set_b13_dashboard_events($b13events) {
        $this->b13_dashboard_events = $b13events;
    }
    ...
    public function send() {
        ...
        // De: {[from.???]}.
        $userfrom = null;
        switch ($this->b13_dashboard_events->userfrom) {
            case 'admin':
                $userfrom = get_admin();
                break;
        }
        ...
        // Para: {[to.???]}.
        $usersto = array();
        switch ($this->b13_dashboard_events->userto) {
            case 'admin':
    ...
    private function load_template() {
        ...
        $this->subject = $this->b13_dashboard_events->subject;
        $this->message = str_replace('{[message]}', $this->b13_dashboard_events->message, $templatecontent);
    }
