...
use local_b13_dashboard\report\files;
...
class dashboard {
    ...
    public function start() {
        dashboard_util::add_breadcrumb("b13 Dashboard");
        dashboard_util::start_page();

        $colsm = 4;
        if (class_exists('local_b13_dashboard\usersonline')) {
            $colsm = 3;
        }
                ...
                <div class="row">
                    <div class="col-sm-' . $colsm . '">
                        <div class="element-box color1">
                            <div class="label">' . get_string_b13('dashboard_title_user') . '</div>
            ...
            echo '
                    <div class="col-sm-3">
                        <div class="element-box color2">
                            <div class="label">' . get_string_b13('dashboard_title_online') . '</div>
        ...
        echo '
                    <div class="col-sm-' . $colsm . '">
                        <div class="element-box color3">
                            <div class="label">' . get_string_b13('dashboard_title_course') . '</div>
                    ...
                    <div class="col-sm-' . $colsm . '">
                        <div class="element-box color4">
                            <div class="label">' . get_string_b13('dashboard_title_disk') . '</div>
    ...
    private function last_grades() {
        ...
        foreach ($lastgrades as $grade) {
            ...
            if ($grade->itemtype == 'mod') {
                $evaluation = get_string_b13('dashboard_grade_inmod', $grade);
            } else if ($grade->itemtype == 'course') {
                $evaluation = get_string_b13('dashboard_grade_incourse', $grade);
            } else {
                continue;
            }

            $gradetext = number_format($grade->finalgrade, 1, get_string('decsep', 'langconfig'), '') . ' ' .
                get_string_b13('dashboard_grade_of') . ' ' . intval($grade->rawgrademax);
            ...
            echo '<div class="media dashboard-grade-list">
                ...
                fullname($user) . '</a>
                          ...
                          <p>' . get_string_b13('dashboard_grade_text',
                    ['grade' => $gradetext, 'evaluation' => $evaluation]) . '</p>
                          <div class="date"><small>' . get_string_b13('dashboard_grade_in') .
                ' <i>' . userdate($grade->timemodified,
                    get_string_b13('dateformat')) . '</i></small></div>
                      </div>
                      <div class="clear"></div>
                  </div>';
    ...
    private function last_enroll() {
        ...
        foreach ($lastenroll as $enrol) {
            ...
            if ($user) {
                ...
                $statusmatricula = '<span class="btn-dangerpadding-0-8 border-radius-5 text-nowrap">' . get_string_b13('dashboard_enrol_inactive') . '</span>';
                if ($enrol->status == 0) {
                    $statusmatricula = '<span class="btn-successpadding-0-8 border-radius-5 text-nowrap">' . get_string_b13('dashboard_enrol_active') . '</span>';
                }
                ...
                echo '<div class="media dashboard-grade-list">
                    ...
                    fullname($user) . '</a>
                              ...
                              <p>' . get_string_b13('dashboard_enrol_text', $enrol) . '
                                  <span class="status">' . $statusmatricula . '</span>
                              </p>
                              <div class="date"><small>' . get_string_b13('dashboard_enrol_lastmodifield') . ' <i>' .
                    userdate($enrol->timemodified, get_string_b13('dateformat')) . '</i></small></div>
                          </div>
                          <div class="clear"></div>
                      </div>';
            }
