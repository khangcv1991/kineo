...
namespace local_b13_dashboard\vo;

defined('MOODLE_INTERNAL') || die();

/**
 * Class b13_dashboard_events
 * @package local_b13_dashboard\vo
 */
class b13_dashboard_events extends \stdClass {
    /**
     * @var int
     */
    public $id;
    ...
    public static function create($module, $eventname, $userfrom, $userto, $subject, $message = null) {
        $event = new b13_dashboard_events();
        $event->module = $module;
    ...
    public static function create_by_object($item) {
        $return = new b13_dashboard_events();
