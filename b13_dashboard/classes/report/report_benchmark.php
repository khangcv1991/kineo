...
namespace local_b13_dashboard\report;
 ...
 *
 * @package local_b13_dashboard\report
 */
class report_benchmark {
    /**
     * @var array
    ...
    public function __construct() {
        ...
        foreach ($tests as $name) {
            ...
            $benchs[$name] = array(
                    ...
                    'name' => get_string($name . 'name', 'local_b13_dashboard'),
                    'info' => get_string($name . 'moreinfo', 'local_b13_dashboard'),
                ) + $result;
        }
