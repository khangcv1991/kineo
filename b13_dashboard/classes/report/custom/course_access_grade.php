...
namespace local_b13_dashboard\report\custom;
...
use local_b13_dashboard\util\url_util;

/**
 * Class course_access_grade
 *
 * @package local_b13_dashboard\report\custom
 */
class course_access_grade {
    ...
    public function name() {
        return get_string_b13('reports_report_courses-4');
    }
    ...
    public function generate() {
        ...
        if ($courseid == 0) {
            header::notfound(get_string_b13('courses_notound'));
        }
        ...
        button::info(get_string_b13('reports_export'), url_util::querystring() . "&export=xls");
        ...
        echo '<tr bgcolor="#C5C5C5" style="background-color: #c5c5c5;" >
            ...
            get_string_b13('user_table_fullname') . '</td>
                <td align="center" bgcolor="#979797" style="text-align:center;">' .
            get_string_b13('user_table_email') . '</td>';
        ...
        foreach ($allusercourse as $user) {
            ...
            foreach ($modinfo as $infos) {
                ...
                if ($logresult && $logresult->contagem) {
                    $this->td(get_string_b13('reports_access_n', $logresult->contagem), 'text-nowrap bg-success', 'DFF0D8');
                    ...
                    $this->td2('<span style="color: #282828">' . get_string_b13('reports_noneaccess') .
