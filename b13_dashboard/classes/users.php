...
use local_b13_dashboard\util\datatable_search_util;
...
class users {
    ...
    public function dashboard() {
        dashboard_util::add_breadcrumb(get_string_b13('user_title'));
        ...
        $table->add_header(get_string_b13('user_table_fullname'), 'fullname');
        $table->add_header(get_string_b13('user_table_username'), 'username');
        $table->add_header(get_string_b13('user_table_email'), 'email');
        $table->add_header(get_string_b13('user_table_phone'), 'phone1');
        $table->add_header(get_string_b13('user_table_celphone'), 'phone2');
        $table->add_header(get_string_b13('user_table_city'), 'city');
    ...
    public function load_all_users() {
        ...
        $search->execute_sql_and_return("
            ...
            'local_b13_dashboard\util\user_util::column_fullname');
    }
    ...
    public function details() {
        ...
        header::notfound_null($user, get_string_b13('profile_notfound'));

        dashboard_util::add_breadcrumb(get_string_b13('profile_title'), '?classname=users&method=dashboard');
