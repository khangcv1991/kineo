...
function xmldb_local_b13_dashboard_install() {
    set_config('enablegravatar', 1);
    set_config('gravatardefaulturl', 'mm');

    set_config('webpages_theme', 'standard', 'local_b13_dashboard');
    set_config('notificacao-template', 'Cinza.html', 'local_b13_dashboard');
